    ...
    public static function getForm(ProductCategory $productCategory = null)
    {
        ...
        return "
            ...
            <label for=\"name\"><span>Name<span class=\"required\">*</span></span> 
              <input type=\"text\" class=\"input-field\" name=\"name\" value=\"$name\" maxlength=\"100\" placeholder=\"Name\" />
            </label>
            
            <label for=\"name\"><span>Beschreibung<span class=\"required\">*</span></span> 
              <textarea name=\"description\" class=\"textarea-field\" value=\"$description\" placeholder=\"Beschreibung\"></textarea>
              </label>	
